...
public partial class CornMaker
{
    ...
    /// <returns></returns>
    public CornMaker IntervalMinutes(int startMinutes, int minutesInterval)
    {
    ...
    /// <returns></returns>
    public CornMaker AtMinutes(params int[] minutes)
    {
    ...
    /// <returns></returns>
    public CornMaker RangeMinutes(int startMinutes, int endMinutes)
    {
