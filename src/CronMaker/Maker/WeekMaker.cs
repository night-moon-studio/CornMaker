...
public partial class CronMaker
{
    ...
    /// <returns></returns>
    public CronMaker DayOfWeek(int week,int day)
    {
    ...
    /// </summary>
    /// <returns></returns>
    public CronMaker AtDayOfLastWeek(int weekDay)
    {
    ...
    /// <returns></returns>
    public CronMaker IntervalWeek(int startWeek, int weekInterval)
    {
    ...
    /// <returns></returns>
    public CronMaker AtWeek(params int[] week)
    {
    ...
    /// <returns></returns>
    public CronMaker RangeWeek(int startWeek, int endWeek)
    {
